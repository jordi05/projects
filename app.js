...
const translations = {
  es: {
    ...
    pricingLead: "Empieza gratis y desbloquea extras cuando necesites mas potencia.",
    pricingFreeTitle: "Gratis",
    pricingFreePrice: "0 eur",
    pricingFree1: "Todas las herramientas basicas",
    pricingFree2: "Exportar PDF y PNG",
    pricingFree3: "Sin registro",
    pricingFreeCta: "Pedir mejoras",
    pricingProBadge: "Recomendado",
    pricingProTitle: "Pro",
    pricingProPrice: "9 eur / mes",
    pricingPro1: "Exportes en lote",
    pricingPro2: "Plantillas de regex",
    pricingPro3: "Soporte prioritario",
    pricingProCta: "Solicitar acceso",
    pricingTeamTitle: "Equipo",
    pricingTeamPrice: "Consultar",
    pricingTeam1: "Acceso compartido",
    pricingTeam2: "Integracion con docu",
    pricingTeam3: "Facturacion anual",
    pricingTeamCta: "Hablar ahora",
    contactTitle: "Contacto rapido",
    contactLead: "Cuentame que necesitas y te respondo con un plan claro.",
    contactName: "Nombre",
    contactNamePlaceholder: "Tu nombre",
    contactEmail: "Email",
    contactEmailPlaceholder: "tucorreo@email.com",
    contactMessage: "Mensaje",
    contactMessagePlaceholder: "Que necesitas exactamente",
    contactCta: "Enviar",
    contactFast: "Respuesta rapida",
    contactFastValue: "En menos de 24h",
    contactScope: "Servicios",
    contactScopeValue: "Web, SEO, automatizacion",
    contactProof: "Confianza",
    contactProofValue: "Trabajo por objetivos",
  ...
  en: {
    ...
    pricingLead: "Start free and unlock extras when you need more power.",
    pricingFreeTitle: "Free",
    pricingFreePrice: "0 eur",
    pricingFree1: "All core tools",
    pricingFree2: "Export PDF and PNG",
    pricingFree3: "No signup",
    pricingFreeCta: "Request improvements",
    pricingProBadge: "Recommended",
    pricingProTitle: "Pro",
    pricingProPrice: "9 eur / month",
    pricingPro1: "Batch exports",
    pricingPro2: "Regex templates",
    pricingPro3: "Priority support",
    pricingProCta: "Request access",
    pricingTeamTitle: "Team",
    pricingTeamPrice: "Contact us",
    pricingTeam1: "Shared access",
    pricingTeam2: "Docs integration",
    pricingTeam3: "Annual billing",
    pricingTeamCta: "Talk now",
    contactTitle: "Fast contact",
    contactLead: "Tell me what you need and I will reply with a clear plan.",
    contactName: "Name",
    contactNamePlaceholder: "Your name",
    contactEmail: "Email",
    contactEmailPlaceholder: "you@email.com",
    contactMessage: "Message",
    contactMessagePlaceholder: "What do you need exactly",
    contactCta: "Send",
    contactFast: "Fast response",
    contactFastValue: "Within 24h",
    contactScope: "Services",
    contactScopeValue: "Web, SEO, automation",
    contactProof: "Trust",
    contactProofValue: "Goal based work",
